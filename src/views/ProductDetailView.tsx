...
import { FaStar, FaShoppingCart, FaChevronRight, FaShieldAlt, FaTruck, FaUndo, FaMinus, FaPlus } from 'react-icons/fa';
import { FiArrowRight, FiTag, FiShoppingBag, FiHeart } from 'react-icons/fi';
